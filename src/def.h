...
#define ID_END_OFFSET    ID_NODE_OFFSET + ID_SIZE + D_R_SIZE
#define PID_NODE_OFFSET  ID_END_OFFSET + ID_SIZE + D_R_SIZE
...
#define RECORD_SIZE      (TIME_SIZE + 3*ID_SIZE + ID_BRANCH_SIZE + STATE_SIZE + INFO_SIZE + 6*D_R_SIZE + 1)
...
#define ID_NODE_END_RECORD_SIZE     (ID_SIZE + D_R_SIZE + ID_SIZE + 1)
...
#define ID_NODE_OFFSET_END          ID_SIZE + D_R_SIZE
...
#ifdef TESTBBTREE
    #define FILE_NAME "./../bbtree/data/buf.data"
    #define FILE_NAME_NEW "./../bbtree/data/buf_new.data"
    #define FILE_PATH_DEPTH "./../bbtree/data/depth.data"
    #define FILE_NODE_END "./../bbtree/data/node_end.data"
    #define FILE_DEPTH_FOLDER "./../bbtree/data/"
#elif defined(TREEVIS)
